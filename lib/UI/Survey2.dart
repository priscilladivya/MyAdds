...
class SurveyScreen2 extends StatefulWidget {
  @override
  _SurveyScreen2State createState() => _SurveyScreen2State();
}
            ...
            Container(
              decoration: BoxDecoration(
                ...
                color: MyColors.colorLight,
                  border: Border.all(color: MyColors.darkGray)
              ),
