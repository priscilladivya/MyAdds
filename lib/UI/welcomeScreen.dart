...
import 'package:myads_app/UI/signInScreen.dart';
        ...
        child: Column(
          children: [
            ...
            Center(
                child: Text(
              MyStrings.WelcomeTo,
              style: MyStyles.robotoLight60.copyWith(letterSpacing: Dimens.letterSpacing_14, color: MyColors.accentsColors, fontWeight: FontWeight.w100),
            )),
            RichText(
              text: new TextSpan(
                ...
                children: <TextSpan>[
                  new TextSpan(
                      text: MyStrings.My,
                      style: MyStyles.robotoLight60.copyWith(letterSpacing: Dimens.letterSpacing_14, color: MyColors.accentsColors, fontWeight: FontWeight.bold),
                  ),
                  new TextSpan(
                      text: MyStrings.Ads,
                      style: MyStyles.robotoLight60.copyWith(letterSpacing: Dimens.letterSpacing_14, color: MyColors.accentsColors, fontWeight: FontWeight.w100),
            ...
            Text(MyStrings.Watch,
              style: MyStyles.robotoMedium20.copyWith( color: MyColors.darkGray, fontWeight: FontWeight.w500),
            ),
            SizedBox(height: MediaQuery.of(context).size.height/120,),
            Text(MyStrings.Contribute,
              style: MyStyles.robotoLight20.copyWith( color: MyColors.black, fontWeight: FontWeight.w500),
            ),
            Text(MyStrings.Paid,
              style: MyStyles.robotoLight20.copyWith( color: MyColors.black, fontWeight: FontWeight.w500),
            ),
            SizedBox(height: Dimens.dp_40,),
            InkWell(
                onTap:(){
