...
class _MyCouponScreenState extends State<MyCouponScreen> {
  List<Coupons> myCoupons = <Coupons>[
    ...
    Coupons(
        ...
        status: 'Generated'),
    Coupons(
        date: '1st June 2021', couponType: 'Disney+ Gift Card', status: 'Generated'),
    Coupons(
        date: '1st June 2021', couponType: 'Netflix Gift Card', status: 'Generated'),
    Coupons(
        date: '1st July 2021', couponType: 'Netflix Gift Card', status: 'Generated'),
    Coupons(
        date: '1st July 2021', couponType: 'Netflix Gift Card', status: 'Generated'),
    Coupons(
          ...
          children: [
            ...
            DataTable(
              columns: const <DataColumn>[
                ...
                columnSpacing: 20.0,
                headingRowHeight: 0,
                rows: myCoupons != null? List.generate(
                    myCoupons.length, (index) =>

                    DataRow(
                      color: MaterialStateProperty.resolveWith<Color>(
                              (Set<MaterialState> states) {
                            return index % 2 == 0? MyColors.colorLight : Colors.white;
                          }),
                      cells: <DataCell>[
                        DataCell(Text(myCoupons[index].date,style: MyStyles.robotoMedium14.copyWith(color: MyColors.lightGray, fontWeight: FontWeight.w100),),),
                        DataCell(Text(myCoupons[index].couponType,style: MyStyles.robotoMedium14.copyWith(color: MyColors.black, fontWeight: FontWeight.w100),),),
                        DataCell(Text(myCoupons[index].status,style: MyStyles.robotoMedium14.copyWith(color: MyColors.lightGray, fontWeight: FontWeight.w100),)),
                        DataCell(Image.asset(MyImages.copyIcon,),),
                      ],
                    )
                ) : SizedBox()
            ),
