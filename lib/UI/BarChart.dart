        ...
        child: Column(
          children: [
            Padding(
              ...
              child: Center(
                child: Text(MyStrings.graphs,
                  style: MyStyles.robotoMedium30.copyWith(letterSpacing: 1.0, color: MyColors.accentsColors, fontWeight: FontWeight.w100),
                ),
              ),
            ),
            Divider(
            ...
            Padding(
              ...
              child: Center(
                child: Text(MyStrings.dailyViewingTime,
                  ...
                  child: Row(
                    ...
                    children: [
                      ...
                      Text('Minutes per day',
                        style: MyStyles.robotoMedium12.copyWith(letterSpacing: 1.0, color: MyColors.black, fontWeight: FontWeight.w100),
                      ),
                    ],
                  ),
                ),
